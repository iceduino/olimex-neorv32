...
OLIMEX_NEORV32_COM_PATH = $(OLIMEX_NEORV32_HOME)/sw/common
...
# Linker script
LD_SCRIPT = $(OLIMEX_NEORV32_COM_PATH)/neorv32.ld
...
$(APP_IMG): main.bin $(IMAGE_GEN)
	...
	@echo "Installing application image to $(OLIMEX_NEORV32_HOME)/osflow/boards/olimex/$(APP_IMG)"
	@cp $(APP_IMG) $(OLIMEX_NEORV32_HOME)/osflow/boards/olimex/.
...
$(BOOT_IMG): main.bin $(IMAGE_GEN)
	...
	@echo "Installing bootloader image to $(OLIMEX_NEORV32_HOME)/osflow/boards/olimex/$(BOOT_IMG)"
	@cp $(BOOT_IMG) $(OLIMEX_NEORV32_HOME)/osflow/boards/olimex/.
